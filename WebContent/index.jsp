	...
	<%@page import="java.sql.Connection" %>
		...
		<body>
			<%@ include file="common_content/navbar.jsp" %>
				...
				<% Connection con=DBConnection.getCon(); //System.out.println( +"We are at 1st page of site. "  con);
	%>
		...
		class=" container-fluid d-flex align-items-center back-img justify-content-center text-white main-data">
					<div class="text-center">
						<div class="d-flex align-items-center justify-content-center">
							<a href="register.jsp" class="btn px-3 btn-custom btn-outline-dark fs-5 mx-1"><i
									class="fa fa-user-plus"> Register</i> </a> <a href="login.jsp"
								class="btn px-3 btn-custom btn-outline-dark fs-5 mx-1"><i class="fa fa-user-circle">
									login</i> </a>
						</div>
