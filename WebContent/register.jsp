		...
		<%@ include file="common_content/navbar.jsp" %>
			<div class="main-data d-flex justify-content-center align-items-center">
				<div class="form-outter">
					...
					<% String regMsg=(String) session.getAttribute("reg-sucess"); if (regMsg !=null) { %>
						<div class="alert alert-success" role="alert">
							<%=regMsg%>
								Login: <a href="login.jsp">Click Here...</a>
						</div>
						<% session.removeAttribute("reg-sucess"); } String FailedMsg=(String)
							session.getAttribute("reg-failed"); if (FailedMsg !=null) { %>
							...
							<% session.removeAttribute("reg-failed"); } %>
								...
								<form method="post" action="UserServlet">
									...
									<br>
									<section>
										<label>E-mail:</label> <br> <input type="text" placeholder="E-mail Address"
											name="uEmail">
									</section>
									<br>
									<section>
									...
									<br> <br> <input type="submit" class="btn btn-pill" value="Submit">
								</form>
				</div>
			</div>
