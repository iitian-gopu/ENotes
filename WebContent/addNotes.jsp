					...
					<div class="container-fluid p-3">
						<div class="container">
							...
							<form action="AddNotesServlet" method="post">
								<% UserDetails ud=(UserDetails) session.getAttribute("userDetails"); if (ud !=null) { %>
									<input type="hidden" name="uid" value="<%=ud.getId()%>"><input type="hidden"
										name="uname" value="<%=ud.getName()%>"><input type="hidden" name="uemail"
										value="<%=ud.getEmail()%>">
									<% } %>
										<div class="mb-3">
